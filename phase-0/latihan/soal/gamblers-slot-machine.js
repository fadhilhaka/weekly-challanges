...
function evaluateSlotMachine(Arr) {
  ...
  if (Arr[0] === Arr[1]) {
    if (Arr[0] === Arr[2]) {
      hasil = Arr[0] * 3 * 200
      return 'YOU WIN ' + hasil + ' DOLLARS, YOUR TOTAL CREDIT BALANCE IS ' + (money + hasil) + ' DOLLAR'
    } else if (Arr[0] !== Arr[2]) {
      hasil = (Arr[0] * 2 + Arr[2]) * 100
      return 'YOU WIN ' + hasil + ' DOLLARS, YOUR TOTAL CREDIT BALANCE IS ' + (money + hasil) + ' DOLLAR'
    }
  } else if (Arr[0] !== Arr[1]) {
    hasil = 300
    return 'YOU LOSE ' + hasil + ' DOLLAR,  YOUR TOTAL CREDIT BALANCE IS ' + (money - hasil) + ' DOLLAR'
  }
}
